...
import { lipSync, lipSyncGenerator } from "./modules/lip-sync.mjs";
import { sendDefaultMessages, defaultResponse } from "./modules/defaultMessages.mjs";
import { convertAudioToText, convertBlobToText } from "./modules/whisper.mjs";
...
wsServer.on('request', async request => {
  ...
  async function stopAsr(){
    ...
    const generator = lipSyncGenerator({ messages: openAImessages.messages })
